...
global.game_height = 290;

box = sprTextBox;
portraitFrame = sprPortraitFrame;
portrait = sprPortraits;
namebox = sprNameplate;
...
port_x = (global.game_width - box_width - port_width) * -2.25;
port_y = (global.game_height - box_height - port_height) * 15;
